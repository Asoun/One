...
public class SellerServiceTest {
	...
	@Test
	public void sellersPostTest() throws NotFoundException {
		when(repository.save(seller)).thenReturn(seller);
		assertEquals(seller, service.sellersPost(seller).getBody());
	}
	
	@Test
	public void sellersSellerNameGetTest() throws NotFoundException {
	...
	@Test
	public void sellersSellerIdGetTest() throws NotFoundException {
		Long id = 234l;
		when(repository.findOne(id)).thenReturn(seller);
		assertEquals(seller, service.sellersSellerIdGet(id).getBody());
	}
